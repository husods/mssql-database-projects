...
-- Bu sorguyu çalıştırdığınızda, @searchName_injection2 değişkeninin değeri
-- 'Luxury'' --' olduğu için, LIKE ifadesi aslında 'LIKE '%Luxury' olarak
-- değerlendirilir (çünkü '--' sonrasını yorum satırı yapar). Bu da,
-- 'name' sütununda 'Luxury' ile biten tüm kayıtları döndürür. Saldırgan,
-- yorum satırını kullanarak sorgunun sonraki kısımlarını etkisiz hale
-- getirebilir ve arama kriterini bu şekilde manipüle edebilir.
...
-- =============================================
-- Section 3: SQL Injection Testleri (Devam)
-- =============================================
...
-- Bu sorguyu çalıştırdığınızda, 'name' sütununda 'Luxury' ile başlayan
...
-- Bu bölümdeki denemeler, SQL Injection'ın temel prensiplerini ve
-- korunma yöntemlerinin önemini pratik olarak göstermektedir. Projenizde
-- bu çıktıları ve yorumları kullanarak SQL Injection konusunu açıklayabilirsiniz.